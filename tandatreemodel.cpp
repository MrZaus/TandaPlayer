...
TandaTreeModel::TandaTreeModel(const QStringList &headers, const QString &data, QObject *parent)
...
QModelIndex TandaTreeModel::index(int row, int column, const QModelIndex &parent) const
{
...
bool TandaTreeModel::insertColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool TandaTreeModel::insertRows(int position, int rows, const QModelIndex &parent)
{
    TandaTreeItem *parentItem = getItem(parent);
    bool success;
...
bool TandaTreeModel::removeColumns(int position, int columns, const QModelIndex &parent)
{
    bool success;
...
bool TandaTreeModel::removeRows(int position, int rows, const QModelIndex &parent)
{
    TandaTreeItem *parentItem = getItem(parent);
    bool success = true;
...
bool TandaTreeModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if (role != Qt::EditRole)
        return false;
...
void TandaTreeModel::setupModelData(const QStringList &lines, TandaTreeItem *parent)
{
